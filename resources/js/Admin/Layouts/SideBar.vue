    ...
    <template>
        <div class="w-64 bg-green-700 dark:bg-gray-900 h-screen pt-16 overflow-x-auto">
            ...
            <div class="flex flex-col mt-2 border-green-300 border-t dark:border-gray-700">
                ...
                <router-link to="/article-pages" :class="`nav-links hover:bg-green-700 dark:hover:bg-gray-700 ${$route.name.includes('ArticlePages')? 'bg-blue-700 dark:bg-gray-600' : ''}`">Articles</router-link>
                <router-link to="/faqs" :class="`nav-links hover:bg-green-700 dark:hover:bg-gray-700 ${$route.name.includes('Faqs')? 'bg-blue-700 dark:bg-gray-600' : ''}`">FAQs</router-link>
                <router-link to="/quick-links" :class="`nav-links hover:bg-green-700 dark:hover:bg-gray-700 ${$route.name.includes('QuickLinks')? 'bg-blue-700 dark:bg-gray-600' : ''}`">Quick Links</router-link>
                <router-link to="/images" :class="`nav-links hover:bg-green-700 dark:hover:bg-gray-700 ${$route.name.includes('Images')? 'bg-blue-700 dark:bg-gray-600' : ''}`">Images</router-link>
                ...
                <router-link to="/accounts" :class="`nav-links hover:bg-green-700 dark:hover:bg-gray-700 ${$route.name.includes('Accounts')? 'bg-blue-700 dark:bg-gray-600' : ''}`">Accounts</router-link>
