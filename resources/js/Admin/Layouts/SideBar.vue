    ...
    <template>
        <div class="w-64 bg-green-700 dark:bg-gray-900 h-screen pt-16 overflow-x-auto">
            ...
            <div class="flex flex-col mt-2 border-green-300 border-t dark:border-gray-700">
                <router-link to="/super-user" :class="`nav-links hover:bg-green-500 dark:hover:bg-gray-700 ${$route.name.includes('Dashboard')? 'bg-green-900 dark:bg-gray-600' : ''}`">Home</router-link>
                <router-link to="/navigation" :class="`nav-links hover:bg-green-500 dark:hover:bg-gray-700 ${$route.name.includes('Navigation')? 'bg-green-900 dark:bg-gray-600' : ''}`">Navigation</router-link>
                <router-link to="/generic-pages" :class="`nav-links hover:bg-green-500 dark:hover:bg-gray-700 ${$route.name.includes('GenericPages')? 'bg-green-900 dark:bg-gray-600' : ''}`">Generic Page</router-link>
                ...
                <router-link to="/article-pages" :class="`nav-links hover:bg-green-500 dark:hover:bg-gray-700 ${$route.name.includes('ArticlePages')? 'bg-green-900 dark:bg-gray-600' : ''}`">Articles</router-link>
                <router-link to="/faqs" :class="`nav-links hover:bg-green-500 dark:hover:bg-gray-700 ${$route.name.includes('Faqs')? 'bg-green-900 dark:bg-gray-600' : ''}`">FAQs</router-link>
                <router-link to="/quick-links" :class="`nav-links hover:bg-green-500 dark:hover:bg-gray-700 ${$route.name.includes('QuickLinks')? 'bg-green-900 dark:bg-gray-600' : ''}`">Quick Links</router-link>
                <router-link to="/images" :class="`nav-links hover:bg-green-500 dark:hover:bg-gray-700 ${$route.name.includes('Images')? 'bg-green-900 dark:bg-gray-600' : ''}`">Images</router-link>
                <router-link to="/accounts" :class="`nav-links hover:bg-green-500 dark:hover:bg-gray-700 ${$route.path.includes('accounts')? 'bg-green-900 dark:bg-gray-600' : ''}`">Accounts</router-link>
