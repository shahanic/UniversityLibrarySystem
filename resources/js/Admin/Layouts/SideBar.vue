    ...
    <template>
   <div class="w-64 bg-green-700 dark:bg-gray-900 h-screen pt-16 overflow-x-auto shadow-lg">
    ...
    <div class="flex flex-col mt-2 border-green-300 border-t dark:border-gray-700">
        <router-link to="/super-user" :class="`nav-links hover:bg-green-700 dark:hover:bg-gray-800 ${$route.name.includes('Dashboard') ? 'bg-green-800 dark:bg-gray-800' : ''}`">
            Home
        </router-link>
        <router-link to="/navigation" :class="`nav-links hover:bg-green-600 dark:hover:bg-gray-800 ${$route.name.includes('Navigation') ? 'bg-green-800 dark:bg-gray-800' : ''}`">
            Navigation
        </router-link>
        <router-link to="/generic-pages" :class="`nav-links hover:bg-green-600 dark:hover:bg-gray-800 ${$route.name.includes('GenericPages') ? 'bg-green-800 dark:bg-gray-800' : ''}`">
            Generic Pages
        </router-link>
        ...
        <router-link to="/article-pages" :class="`nav-links hover:bg-green-600 dark:hover:bg-gray-800 ${$route.name.includes('ArticlePages') ? 'bg-green-800 dark:bg-gray-800' : ''}`">
            Articles
        </router-link>
        <router-link to="/faqs" :class="`nav-links hover:bg-green-600 dark:hover:bg-gray-800 ${$route.name.includes('Faqs') ? 'bg-green-800 dark:bg-gray-800' : ''}`">
            FAQs
        </router-link>
        <router-link to="/quick-links" :class="`nav-links hover:bg-green-600 dark:hover:bg-gray-800 ${$route.name.includes('QuickLinks') ? 'bg-green-800 dark:bg-gray-800' : ''}`">
            Quick Links
        </router-link>
        <router-link to="/images" :class="`nav-links hover:bg-green-600 dark:hover:bg-gray-800 ${$route.name.includes('Images') ? 'bg-green-800 dark:bg-gray-800' : ''}`">
            Images
        </router-link>
        ...
        <router-link to="/accounts" :class="`nav-links hover:bg-green-600 dark:hover:bg-gray-800 ${$route.name.includes('Accounts') ? 'bg-green-800 dark:bg-gray-800' : ''}`">
            Accounts
        </router-link>
