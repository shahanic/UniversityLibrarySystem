  ...
  <admin-layout>
    <template v-slot:main>
      <div>
        ...
        <AddAccountModal :isVisible="showModal" @close="showModal = false">
          <div>
            <div>
        ...
        <table class="min-w-full border-collapse border border-gray-300">
          ...
          <tbody>
            <tr v-for="(userx, index) in user.users" :key="index" class="bg-gray-700">
              ...
              <td class="border border-white-300 text-white p-2">{{ userx.name }}</td>
              <td class="border border-white-300 text-white p-2">{{ userx.email }}</td>
              <td class="border border-white-300 text-white p-2">{{ userx.username }}</td>
              <td class="border border-white-300 text-white p-2">{{ userx.role }}</td>
              <td class="border border-white-300 text-white p-2">{{ userx.password }}</td>
