<template>
    <div class="v-suggestions">
        <input type="text" :class="extendedOptions.inputClass"
               ...
               class=" border-gray-50 bg-gray-200/50 dark:bg-gray-600/70 dark:border-gray-600"
               >
        <div class="suggestions shadow-lg dark:!bg-gray-600 mt-1" style="overflow-y: auto; max-height: 60vh">
            <ul class="items !border-none" v-show="items.length > 0 && showItems === true">
                <li class="item dark:hover:!bg-gray-700"
                    :key="index"
